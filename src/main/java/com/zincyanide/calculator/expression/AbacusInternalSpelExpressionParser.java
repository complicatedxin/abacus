...
public class AbacusInternalSpelExpressionParser extends TemplateAwareExpressionParser
{
            ...
            throws ParseException
    {
        try {
            ...
            return new AbacusSpelExpression(expressionString, ast, this.configuration);
        }
